    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="mynavbar">
        <ul class="navbar-nav me-auto">
          ...
          <!-- 로그인한 사람중 ROLE_MEMBER or ROLE_ADMIN 권한 있는 사람에게만 보이는 메뉴 -->
            ...
            <a class="nav-link" href="javascript:void(0)">Admin</a>
				...
				<form action="${pageContext.request.contextPath}/user/logout" method="POST" TODO="">
					...
					<span class="d-flex"> <span class="text-light p-2"><span
							TODO="">${username }(${userdetails.user.name })</span>
							님 환영합니다</span> <span><button class="btn btn-danger" type="submit">Logout</button></span>
					</span>
				</form>
				</sec:authorize>
			</div>
